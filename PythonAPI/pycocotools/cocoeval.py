...
class COCOeval:
    ...
    def accumulate_details(self, p = None):
        '''
        Accumulate per image evaluation results and store the result in self.eval, with more details
        ...
        re_precision = -np.ones((1,R,K,A,M)) # -1 for the precision of absent categories
        re_recall = -np.ones((1,R,K,A,M))
    ...
    def summarize_details(self):
        ...
        def _summarize( ap=1, iouThr=None, areaRng='all', maxDets=100 ):
            ...
            if ap == 1:
                ...
                s = self.eval['re_precision']
                s = s[0,:,aind,mind]
                
            elif ap == 3:
                s = self.eval['re_recall']
                s = s[0,:,aind,mind]
        ...
        def _summarizeDets():
            ...
            stats[13] = _summarize(3, maxDets=self.params.maxDets[2])
            return stats
        def _summarizeKps():
            stats = np.zeros((10,))
